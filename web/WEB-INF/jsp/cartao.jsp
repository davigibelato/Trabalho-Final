<%-- 
    Document   : cartao
    Created on : 04/06/2024, 14:47:38
    Author     : Senai
--%>
                    ...
                    <div class="box-global">                        
                        <div class="box-left">
                            <div class="cartao">
                                ...
                                <div class="inputs">
                                    <div class="high">
                                        <input type="number" placeholder="Numero do Cartão" id="numeroCartao" name="numeroCartao">
                                        <input type="text" placeholder="Nome do Titular" id="nomeTitular" name="nomeTitular">
                                    </div>
                                    <div class="low">
